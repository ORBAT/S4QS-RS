...
Uploader.prototype.msgsToManifests = function(baseName, msgStream) {
  ...
  this._logger.debug(`started msgsToManifests for base name ${baseName}`);
  return msgStream
...
var Manifest = exports.Manifest = function Manifest(s3, options) {
  ...
  var dateAndFile = `${datePart}${this.baseName}-${ut.randomString(7)}.json`;
...
Manifest.prototype._upload = function _upload(retries) {
  ...
  this._logger.info({nMsgs: this.length}, "Starting upload");
