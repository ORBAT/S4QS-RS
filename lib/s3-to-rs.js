 ...
 * @private
 */
TimeSeriesManager.prototype._createView = Promise.method(function(name, tables) {
  ...
  var colNames = _.map(opts.columns, _.flow(_.partial(_.words, _, /w+/g), ut.get(0))).join(', ')
    , viewTables = _.takeRight(tables, opts.tablesInView)
    , viewName = name + this._postfix + "_view"
    ...
    .tap(function () {
      ...
      this._pruneTsTables(name).bind(this)
        .then(function (remaining) {
          return this._createView(name, remaining).catch(function (err) {
