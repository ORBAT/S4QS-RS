...
var S3Copier = exports.S3Copier = function S3Copier(poller, pg, s3, rs, copyParams, options) {
  ...
  this._instrumenter = new instr.Instrumenter(new Statsd(options.statsd));
...
S3Copier.prototype._connAndCopy = function _connAndCopy(s3URI, base, table) {
  ...
  var copyTo = ins.instrument("copyTo", _copyTo);
  ...
  var dedupCopy = ins.instrument("dedupCopy", _dedupCopy);

  return this._usingPg(ins.instrument("total" ,function (client) {
