...
var S3Copier = exports.S3Copier = function S3Copier(poller, pg, s3, rs, copyParams, options) {
  ...
  this._tsMgr = new TimeSeriesManager(this._usingPg, copyParams.schema, options.tablePostfix || "", options.timeSeries);
...
TimeSeriesManager.prototype.tsTableFor = Promise.method(function (name) {
  ...
  var now = Date.now()
    , postf = this._postfix + "_" + ((now - now % (tsOpts.period * 1000)) / 1000).toFixed(0);
