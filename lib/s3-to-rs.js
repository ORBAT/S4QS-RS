...
var S3Copier = exports.S3Copier = function S3Copier(poller, pg, s3, rs, options) {
  ...
  // i.e. at most as many parallel copies as there are configured tables. Not pretty but works
  var maxParallel = _.without(_.keys(this._options.tableConfig), "timeout").length
