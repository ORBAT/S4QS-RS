...
S3Copier.prototype._connAndCopy = function _connAndCopy(s3URI, txCtx, table) {
  var self = this;

  var cancelCopy = null;

  return this._usingPg(function (client) {
    return Promise.using(ut.withTransaction(client, txCtx), function (client) {
...
S3Copier.prototype._onManifest = function _onManifest(manif) {
  ...
  var txCtx = {context: "COPY for " + manif.manifestURI};

  var handle = function _handle() {

    var doCopy = _.partial(this._connAndCopy.bind(this), manif.manifestURI, txCtx);
...
TimeSeriesManager.prototype._createView = Promise.method(function _createView(viewName, viewTables, columnMap) {
  ...
  return this._usingPg(function (client) {
    return Promise.using(ut.withTransaction(client), function (client) {
